...
void util_Texture_new(util__Texture r0,int r1,int r2) {
	...
	r8 = r1;
	label$d0b51c0_1_11:
	if( r6 >= r8 ) goto label$d0b51c0_1_31;
	++r6;
	r9 = 0;
	r11 = hl_alloc_bytes(r9);
	r9 = 0;
	r9 = 0;
	r10 = hl_types_ArrayBase_allocI32(r11,r9);
	r9 = 0;
	r12 = r2;
	label$d0b51c0_1_21:
	if( r9 >= r12 ) goto label$d0b51c0_1_28;
	++r9;
	if( r10 == NULL ) hl_null_access();
	r13 = 0;
	r13 = hl_types_ArrayBytes_Int_push(r10,r13);
	goto label$d0b51c0_1_21;
	label$d0b51c0_1_28:
	if( r3 == NULL ) hl_null_access();
	r9 = hl_types_ArrayObj_push(r3,((vdynamic*)r10));
	goto label$d0b51c0_1_11;
	label$d0b51c0_1_31:
	r0->tex = r3;
	return;
}
