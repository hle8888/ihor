...
void sdl_Sdl_setGLVersion(int r0,int r1) {
	...
	r9 = NULL;
	r10 = NULL;
	sdl_Sdl_setGLOptions(r4,r6,r7,r8,r9,r10);
	return;
}
...
void sdl_Sdl_onGlContextError() {
	...
	r2 = 0;
	r3 = r0->length;
	if( ((unsigned)r2) < ((unsigned)r3) ) goto label$3370605_6_7;
	r4 = NULL;
	goto label$3370605_6_10;
	label$3370605_6_7:
	r6 = r0->array;
	r5 = ((vdynamic**)(r6 + 1))[r2];
	r4 = (String)r5;
	label$3370605_6_10:
	if( r4 ) goto label$3370605_6_13;
	r7 = (String)s$Unknown;
	r4 = r7;
	label$3370605_6_13:
	r2 = 0;
...
bool sdl_Sdl_processEvents(vclosure* r0) {
	...
	r4 = r2->type;
	r5 = 0;
	if( r4 != r5 ) goto label$3370605_7_18;
	if( !r1 ) goto label$3370605_7_18;
	r6 = false;
	return r6;
	label$3370605_7_18:
	goto label$3370605_7_0;
	label$3370605_7_19:
	r1 = true;
	return r1;
}

int sdl_Sdl_getScreenWidth(sdl__Window r0) {
	sdl_window *r2;
	int r1;
	if( r0 ) goto label$3370605_8_3;
	r1 = sdl_get_screen_width();
	return r1;
	label$3370605_8_3:
	if( r0 == NULL ) hl_null_access();
	r2 = r0->win;
	r1 = sdl_get_screen_width_of_window(r2);
	return r1;
}

int sdl_Sdl_getScreenHeight(sdl__Window r0) {
	sdl_window *r2;
	int r1;
	if( r0 ) goto label$3370605_9_3;
	r1 = sdl_get_screen_height();
	return r1;
	label$3370605_9_3:
	if( r0 == NULL ) hl_null_access();
	r2 = r0->win;
	r1 = sdl_get_screen_height_of_window(r2);
	return r1;
}
...
void sdl_Sdl_message(String r0,String r1,bool* r2) {
	bool r3;
	vbyte *r5, *r6;
	if( r2 ) goto label$3370605_10_3;
	r3 = false;
	goto label$3370605_10_4;
	label$3370605_10_3:
	r3 = *r2;
	label$3370605_10_4:
	if( r0 == NULL ) hl_null_access();
...
hl__types__ArrayObj sdl_Sdl_getDisplayModes(vdynamic* r0) {
	...
	label$3370605_11_13:
	r8 = r1->size;
	if( r2 >= r8 ) goto label$3370605_11_21;
	r6 = ((vdynamic**)(r1 + 1))[r2];
	++r2;
	if( r4 == NULL ) hl_null_access();
	r7 = hl_types_ArrayObj_push(r4,r6);
	goto label$3370605_11_13;
	label$3370605_11_21:
	return r4;
}
...
vvirtual* sdl_Sdl_getCurrentDisplayMode(vdynamic* r0,bool* r1) {
	...
	vdynamic *r3;
	int r4;
	if( r1 ) goto label$3370605_12_3;
	r2 = false;
	goto label$3370605_12_4;
	label$3370605_12_3:
	r2 = *r1;
	label$3370605_12_4:
	r4 = r0 ? r0->v.i : 0;
...
hl__types__ArrayObj sdl_Sdl_getDisplays() {
	...
	label$3370605_13_14:
	r8 = r1->size;
	if( r6 >= r8 ) goto label$3370605_13_55;
	r7 = r6;
	r5 = ((vdynamic**)(r1 + 1))[r6];
	++r6;
	if( r2 == NULL ) hl_null_access();
...
hl__types__ArrayObj sdl_Sdl_getDevices() {
	...
	label$3370605_14_8:
	r7 = r1->size;
	if( r3 >= r7 ) goto label$3370605_14_34;
	r8 = ((vbyte**)(r1 + 1))[r3];
	++r3;
	if( r8 ) goto label$3370605_14_15;
	goto label$3370605_14_34;
	label$3370605_14_15:
	...
	if( r11 ) goto label$3370605_14_27;
	r12 = (String)s$RDP;
	r11 = StringTools_startsWith(r10,r12);
	if( !r11 ) goto label$3370605_14_28;
	label$3370605_14_27:
	goto label$3370605_14_8;
	label$3370605_14_28:
	r11 = true;
...
bool sdl_Sdl_setClipboardText(String r0) {
	bool r1;
	vbyte *r2;
	if( r0 ) goto label$3370605_15_3;
	r1 = false;
	return r1;
	label$3370605_15_3:
	if( r0 == NULL ) hl_null_access();
	r2 = String_toUtf8(r0);
	r1 = sdl_set_clipboard_text(r2);
	return r1;
}

String sdl_Sdl_getClipboardText() {
	String r1;
	vbyte *r0;
	r0 = sdl_get_clipboard_text();
	if( r0 ) goto label$3370605_16_4;
	r1 = NULL;
	return r1;
	label$3370605_16_4:
