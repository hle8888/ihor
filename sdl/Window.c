...
bool sdl_Window_testGL(sdl__Window r0) {
	...
	int r6, r11, r16;
	hl_trap_ctx trap$0;
	hl_trap(trap$0,r1,label$9a2f713_1_157);
	...
	r14 = 1.;
	if( r13 == r14 ) goto label$9a2f713_1_84;
	...
	if( !r7 ) goto label$9a2f713_1_107;
	r20 = &t$String;
	r11 = 2;
	r19 = hl_alloc_array(r20,r11);
	r8 = (String)s$_version_;
	...
	r13 = (double)hl_dyn_castd(&r1,&t$_dyn);
	r14 = 1.;
	if( r13 == r14 ) goto label$9a2f713_1_138;
	...
	r13 = (double)hl_dyn_castd(&r1,&t$_dyn);
	r14 = 1.;
	if( r13 == r14 ) goto label$9a2f713_1_153;
...
int sdl_Window_set_displayMode(sdl__Window r0,int r1) {
	...
	if( !r2 ) goto label$9a2f713_3_19;
	r0->displayMode = r1;
	r5 = 1;
	if( r1 != r5 ) goto label$9a2f713_3_19;
	hl_trap(trap$0,r6,label$9a2f713_3_19);
	r3 = r0->win;
...
void sdl_Window_warpMouse(sdl__Window r0,int r1,int r2) {
	sdl_window *r4;
	r4 = r0->win;
	sdl_warp_mouse_in_window(r4,r1,r2);
	return;
}
...
bool sdl_Window_set_vsync(sdl__Window r0,bool r1) {
	bool r3;
	r3 = r0->vsync;
	if( r3 != r1 ) goto label$9a2f713_20_3;
	return r1;
	label$9a2f713_20_3:
	sdl_set_vsync(r1);
	r0->vsync = r1;
...
bool sdl_Window_get_grab(sdl__Window r0) {
	sdl_window *r2;
	bool r1;
	r2 = r0->win;
	r1 = sdl_get_window_grab(r2);
	return r1;
}

bool sdl_Window_set_grab(sdl__Window r0,bool r1) {
	sdl_window *r3;
	r3 = r0->win;
	sdl_set_window_grab(r3,r1);
	return r1;
}

int sdl_Window_get_id(sdl__Window r0) {
	sdl_window *r2;
	int r1;
	r2 = r0->win;
	r1 = sdl_win_get_id(r2);
	return r1;
}
...
void sdl_Window_present(sdl__Window r0) {
	...
	double r4, r5, r6;
	r2 = r0->vsync;
	if( !r2 ) goto label$9a2f713_27_13;
	...
	if( !(r4 < r6) ) goto label$9a2f713_27_13;
...
void sdl_Window_destroy(sdl__Window r0) {
	...
	vdynamic *r1, *r5;
	hl_trap_ctx trap$0;
	hl_trap(trap$0,r1,label$9a2f713_28_6);
	r3 = r0->win;
	r4 = r0->glctx;
	sdl_win_destroy(r3,r4);
	hl_endtrap(trap$0);
	goto label$9a2f713_28_7;
	label$9a2f713_28_6:
	r5 = NULL;
	label$9a2f713_28_7:
	r3 = NULL;
...
void sdl_Window_new(sdl__Window r0,String r1,int r2,int r3,int* r4,int* r5,int* r6) {
	...
	vclosure *r16, *r18;
	int r7, r8, r9, r12;
	if( r4 ) goto label$9a2f713_32_3;
	r7 = 805240832;
	goto label$9a2f713_32_4;
	label$9a2f713_32_3:
	r7 = *r4;
	label$9a2f713_32_4:
	if( r5 ) goto label$9a2f713_32_7;
	r8 = 805240832;
	goto label$9a2f713_32_8;
	label$9a2f713_32_7:
	r8 = *r5;
	label$9a2f713_32_8:
	if( r6 ) goto label$9a2f713_32_11;
	r9 = 36;
	goto label$9a2f713_32_12;
	label$9a2f713_32_11:
	r9 = *r6;
	label$9a2f713_32_12:
	r10 = true;
	...
	label$9a2f713_32_14:
	r10 = true;
	if( !r10 ) goto label$9a2f713_32_43;
	r11 = sdl_win_create_ex(r7,r8,r2,r3,r9);
	r0->win = r11;
	r11 = r0->win;
	if( r11 ) goto label$9a2f713_32_23;
	...
	r0->glctx = r15;
	r15 = r0->glctx;
	if( !r15 ) goto label$9a2f713_32_32;
	r10 = sdl_gl_init();
	if( !r10 ) goto label$9a2f713_32_32;
	...
	if( !r10 ) goto label$9a2f713_32_39;
	goto label$9a2f713_32_14;
	label$9a2f713_32_39:
	r17 = (sdl__$Sdl)g$_sdl_Sdl;
